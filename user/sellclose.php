...
if(sqlzhuru($_POST[jvs])=="close"){
 ...
 if(panduan("uid,zfmm","epzhu_user where zfmm='".$zfmm."' and uid='".$_SESSION[SHOPUSER]."'")==0){Audit_alert("支付密码有误！","sellclose.php?orderbh=".$orderbh);}
 ...
 $sj=date("Y-m-d H:i:s");
 updatetable("epzhu_order","ddzt='close',closesj='".$sj."' where selluserid=".$userid." and id=".$row[id]);
