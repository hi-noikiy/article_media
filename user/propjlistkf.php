...
function ser(){
location.href="propjlistkf.php?&st1="+document.getElementById("st1").value+"&ifhf="+document.getElementById("sd1").value;
}
function hfonc(x){
layer.open({
  type: 2,
...
<div class="right">
 <ul class="wz">
 <li class="l0">请选择：</li>
 <li class="g_ac0_h g_bc0_h"><a href="propjlistkf.php">商品评价</a></li>
 </ul>

 <ul class="ksedi">
 <li class="l2">
 <a href="propjlistkf.php?ifhf=no" class="a1">查看所有未回复评价(共<?=returncount("epzhu_propjkf where selluserid=".$luserid." and (hf='' or hf is null)")?>个)</a>
 </li>
 <li class="l3">
 ...
 pagef($ses,10,"epzhu_propjkf","order by sj desc");while($row=mysql_fetch_array($res)){
 while1("*","epzhu_prokf where bh='".$row[probh]."'");$row1=mysql_fetch_array($res1);
 ?>
 <ul class="propjlist">
 <li class="l1">商品信息：</li>
 <li class="l2"><strong><a href="../productkf/view<?=$row1[id]?>.html" target="_blank"><?=$row1[tit]?></a></strong></li>
 <li class="l1">评价会员：</li>
