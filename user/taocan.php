...
while0("*","epzhu_taocan where userid=".$userid." and id=".$id);if(!$row=mysql_fetch_array($res)){php_toheader("taocanlist.php?bh=".$bh);}
 
//函数开始
if($_GET[control]=="update"){
 zwzr();
 if(panduan("*","epzhu_taocan where userid=".$userid." and probh='".$bh."' and admin is null and tit='".sqlzhuru($_POST[t1])."' and id<>".$id)==1){Audit_alert("该套餐内容已存在！","taocan.php?id=".$_GET[id]."&bh=".$bh);}
