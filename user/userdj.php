...
if($_GET[control]=="xf"){ //续费
 while1("*","epzhu_userdj where name1='".$userdj."'");if($row1=mysql_fetch_array($res1)){
 ...
 updatetable("epzhu_user","userdjdq='".$dq."' where id=".$rowuser[id]);
 }
 php_toheader("userdj.php?t=suc");
 
}elseif($_GET[control]=="ts"){ //提升等级
 while2("*","epzhu_userdj where name1='".$userdj."'");$row2=mysql_fetch_array($res2);
 while1("*","epzhu_userdj where id=".$_GET[id]);if($row1=mysql_fetch_array($res1)){
 ...
 */
 ...
 updatetable("epzhu_user","userdj='".$row1[name1]."',userdjdq='".$dq."' where id=".$rowuser[id]);
 }
 php_toheader("userdj.php?t=suc");
...
<div class="right">
 ...
 <? 
 while2("*","epzhu_userdj where name1='".$userdj."'");if($row2=mysql_fetch_array($res2)){$nowdj=$row2[xh];}
