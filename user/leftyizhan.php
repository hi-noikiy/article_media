...
<div class="treebox">
 ...
 <li class="level1<? if($leftid==99){?> level11<? }?>">
  <a href="<?=weburl?>user/" class="a0" id="ico99"><em></em>我的中心<i></i></a>
 </li>
 <li class="level1<? if($leftid==1){?> level11<? }?>">
  ...
  <? }else{?>
  <li><a href="<?=weburl?>user/sellorder.php">源码订单(<strong><?=returncount("epzhu_order where selluserid=".$rowuser[id]." and ddzt='wait'")?></strong>)</a></li>
 ...
 <li><a href="<?=weburl?>user/order.php">我的源码</a></li>
  <li><a href="<?=weburl?>user/orderkf.php">我的开发</a> </li>
