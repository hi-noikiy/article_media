...
$sqltask="select * from epzhu_task where bh='".$bh."' and taskty=0 and useridhf=".$userid."";mysql_query("SET NAMES 'GBK'");$restask=mysql_query($sqltask);
...
if($_GET[control]=="add"){
 ...
 $sj=date("Y-m-d H:i:s");
 intotable("epzhu_tasklog","bh,userid,useridhf,admin,txt,sj,fj","'".$bh."',".$rowtask[userid].",".$userid.",2,'".$txt."','".$sj."',''");
