...
layer.open({
  ...
  title:["商品分组","text-align:left"],
  skin: 'layui-layer-rim', //加上边框
  content:['protype2lxwz.php?ty1id='+x, 'no'] 
});
}
function updty1(x){
layer.open({
  ...
  title:["商品分组","text-align:left"],
  skin: 'layui-layer-rim', //加上边框
  content:['protype1wz.php?bh='+x, 'no'] 
});
}
function updty2(x){
layer.open({
  ...
  title:["商品分组","text-align:left"],
  skin: 'layui-layer-rim', //加上边框
  content:['protype2wz.php?bh='+x, 'no'] 
});
}
function glover(x){
...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:;" onclick="NcheckDEL(15,'epzhu_protypewz')" class="a1">删除</a>
 ...
 <? while1("*","epzhu_protypewz where userid=".$luserid." and admin=1 and zt=0 order by xh asc");while($row1=mysql_fetch_array($res1)){?>
 ...
 <? while2("*","epzhu_protypewz where userid=".$luserid." and admin=2 and zt=0 and name1='".$row1[name1]."' order by xh asc");while($row2=mysql_fetch_array($res2)){?>
