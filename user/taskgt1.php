...
$sqltaskhf="select * from epzhu_taskhf where bh='".$bh."' and useridhf=".$userid." and taskty=1 and id=".$hfid."";mysql_query("SET NAMES 'GBK'");$restaskhf=mysql_query($sqltaskhf);
if(!$rowtaskhf=mysql_fetch_array($restaskhf)){php_toheader("tasklist1.php");}

$sqltask="select * from epzhu_task where bh='".$bh."' and taskty=1";mysql_query("SET NAMES 'GBK'");$restask=mysql_query($sqltask);
...
<div class="right">
 ...
 <div class="gdhflist">
  ...
  <? 
  while1("*","epzhu_tasklog where bh='".$bh."' and useridhf=".$userid." order by sj asc");while($row1=mysql_fetch_array($res1)){
  $txt=$row1[txt];
