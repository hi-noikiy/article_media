...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="propjlist.php?ifhf=no" class="a1">查看所有未回复评价(共<?=returncount("epzhu_propj where selluserid=".$luserid." and (hf='' or hf is null)")?>个)</a>
 </li>
 <li class="l3">
 ...
 pagef($ses,10,"epzhu_propj","order by sj desc");while($row=mysql_fetch_array($res)){
