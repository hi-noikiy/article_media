...
while1("*","epzhu_dingdang where ddbh='".$out_trade_no."' and ddzt='wait'");if($row1=mysql_fetch_array($res1)){
 updatetable("epzhu_dingdang","sj='".$sj."',uip='".$uip."',alipayzt='TRADE_SUCCESS',ddzt='suc',ifok=1 where id=".$row1[id]);
 $money1=$row1["money1"];
