...
<div class="right">
 ...
 <div class="favshop">
 <ul class="u1">
 <li class="l1"><img border="0" src="../upload/<?=$row[shopid]?>/shop.jpg" class="tp" width="80" height="80" /><br><a href="favshopmg.php?control=del&id=<?=$row[id]?>"><img border="0" src="img/icon4.gif" border="0" width="18" height="16" /></a></li>
