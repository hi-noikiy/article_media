...
function psel(){
 ...
 location.href="productlistzh.php?"+str;
}
</script>
</head>
<body>
...
<div class="right rightn">
 ...
 <li class="ltj"><input type="button" onclick="psel()" class="bt1" value="搜索" /> <input type="button" onclick="gourl('productlistzh.php')" class="bt2" value="重置" /></li>
 </ul>
 </div>
 <!--搜索E-->
 ...
 <!-- <div class="fbdh-QQ282-92383">
  ...
  <a href="/user/productlistzh.php">开发服务-列表</a> </div>
    <!--发布导航一站网原创开发结束-->
 <!--列表B-->
 <div class="prolist">
  <ul class="procz">
  ...
  <li class="l2">
  <a href="javascript:void(0);" onclick="NcheckDEL(1,'epzhu_prozh')" class="a1">批量上/下架</a>
  <a href="javascript:void(0);" onclick="NcheckDEL(2,'epzhu_prozh')" class="a1">删除选中</a>
  <a href="javascript:void(0);" onclick="NcheckDEL(7,'epzhu_prozh')" class="a1">更新商品</a>
  ...
  <li class="l3"><a href="productlxzh.php">+添加新商品</a></li>
  </ul>
  <ul class="u1">
  <li class="l1">商品信息(共找到<?=returncount("epzhu_prozh".$ses)?>个)</li>
  <li class="l2">售价(元)</li>
  <li class="l3">库存</li>
  <li class="l4">销量</li>
  <li class="l5">最近更新</li>
  ...
  <?
  pagef($ses,10,"epzhu_prozh","order by lastsj desc");while($row=mysql_fetch_array($res)){
  $au1="productzh.php?bh=".$row[bh];
  $au2="../productzh/view".$row[id].".html";
  ?>
  <ul class="u2">
