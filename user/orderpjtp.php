...
while0("*","epzhu_order where orderbh='".$orderbh."' and userid=".$userid);if(!$row=mysql_fetch_array($res)){php_toheader("./");}

if($_GET[control]=="update"){
 updatetable("epzhu_tp","xh=".$_GET[xh]." where id=".$_GET[id]);
...
<div class="right">
 ...
 <li class="l2">
 <a href="javascript:void(0)" onclick="NcheckDEL(13,'epzhu_tp')" class="a2">删除</a>
 </li>
 <li class="l3"></li>
 </ul>
 <? while1("*","epzhu_tp where bh='".$orderbh."' and userid=".$userid." order by xh asc");while($row1=mysql_fetch_array($res1)){$tp="../".str_replace(".","-1.",$row1[tp]);?>
 <ul class="protplist">
