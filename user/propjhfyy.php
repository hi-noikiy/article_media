...
while0("*","epzhu_propjyy where selluserid=".$userid." and id=".$id);if(!$row=mysql_fetch_array($res)){Audit_alert("来源错误","propjlistyy.php","parent.");}

if($_GET[control]=="update"){
 zwzr();
 updatetable("epzhu_propjyy","hf='".sqlzhuru($_POST[s1])."',hfsj='".$sj."' where selluserid=".$userid." and id=".$id);
