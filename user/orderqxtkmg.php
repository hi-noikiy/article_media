...
if(sqlzhuru($_POST[jvs])=="qxtk" && $row[ddzt]=="back"){
 ...
 if(panduan("uid,zfmm","epzhu_user where zfmm='".$zfmm."' and uid='".$_SESSION[SHOPUSER]."'")==0){Audit_alert("支付密码有误！","orderqxtkmg.php?orderbh=".$orderbh);}
 if($row[ddzt]!="back"){Audit_alert("未知错误！","orderviewmg.php?orderbh=".$orderbh);}
...
<div class="right">
 ...
 f1.action="orderqxtkmg.php?orderbh=<?=$orderbh?>";
 }
 </script>
 <form name="f1" method="post" onsubmit="return tj()">
 <ul class="ordercz">
 <li class="l1"><strong>取消退款申请的话，该订单会自动转为交易成功，请务必与卖家沟通好，确认商品没有问题的前提下，再进行该操作</strong></li>
 <li class="l2">请输入您的支付密码：(<a href="zfmmmg.php" class="red">忘了支付密码？</a>)</li>
