...
$id=$_GET[id];
while0("*","epzhu_carym where id=".$id." and userid=".$userid);if(!$row=mysql_fetch_array($res)){Audit_alert("路径错误","carkf.php",".parent");}

if($_GET[control]=="update"){
 $sj=date("Y-m-d H:i:s");	
 updatetable("epzhu_carym","bz='".sqlzhuru1($_POST[content])."' where id=".$id." and userid=".$userid);
