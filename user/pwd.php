...
if($_POST[jvs]=="password"){
 ...
 if(panduan("*","epzhu_user where uid='".$uid."' and pwd='".$pwd."'")==0){Audit_alert("原密码验证失败，返回重试！","pwd.php");}
...
<div class="right">
 ...
 <ul class="uk">
 <? 
 while1("id,uid,pwd,shopzt","epzhu_user where uid='".$_SESSION[SHOPUSER]."'");$row1=mysql_fetch_array($res1);
