...
$userid=$rowuser[id];
while0("*","epzhu_protype where userid=".$userid." and bh='".$bh."'");if(!$row=mysql_fetch_array($res)){Audit_alert("来源错误","protypelist.php","parent.");}
...
if($_GET[control]=="update"){
 ...
 php_toheader("protype1zh.php?t=suc&bh=".$bh);
}
?>
...
f1.action="protype1zh.php?control=update&bh=<?=$bh?>";
}
<? if($_GET["t"]=="suc"){?>
