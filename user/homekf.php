...
<div class="iright">
 ...
 <!--推广E-->
  ...
  <div class="sell">
   ...
   <a href="sellorderkf.php?ddzt=wpay">等待付款(<strong><?=returncount("epzhu_order where selluserid=".$row[id]." and ddzt='wpay'")?></strong>)</a>
   <a href="sellorderkf.php?ddzt=wait">等待发货(<strong><?=returncount("epzhu_order where selluserid=".$row[id]." and ddzt='wait'")?></strong>)</a>
   <a href="sellorderkf.php?ddzt=db">正在担保(<strong><?=returncount("epzhu_order where selluserid=".$row[id]." and ddzt='db'")?></strong>)</a>
   <a href="sellorderkf.php?ddzt=back">退款申请(<strong><?=returncount("epzhu_order where selluserid=".$row[id]." and ddzt='back'")?></strong>)</a>
   <a href="sellorderkf.php?ddzt=suc">交易成功(<strong><?=returncount("epzhu_order where selluserid=".$row[id]." and ddzt='suc'")?></strong>)</a>
   </div>
  ...
  <div class="buy">
   ...
   <div class="d1 dv"><span class="s1">等待付款</span><a class="s2" href="orderkf.php?ddzt=wpay"><?=returncount("epzhu_order where ddzt='wpay' and userid=".$row[id])?></a></div>
   <div class="d2 dv"><span class="s1">正在交易</span><a class="s2" href="orderkf.php?ddzt=db"><?=returncount("epzhu_order where ddzt='db' and userid=".$row[id])?></a></div>
   <div class="d3 dv"><span class="s1">正在退款</span><a class="s2" href="orderkf.php?ddzb=back"><?=returncount("epzhu_order where ddzt='back' and userid=".$row[id])?></a></div>
  </div>
  <!--买家E-->
