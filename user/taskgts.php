...
$sqltask="select * from epzhu_task where bh='".$bh."' and taskty=0 and userid=".$userid."";mysql_query("SET NAMES 'GBK'");$restask=mysql_query($sqltask);
...
<div class="right">
 ...
 <div class="gdhflist">
  ...
  <? 
  while1("*","epzhu_tasklog where bh='".$bh."' order by sj asc");while($row1=mysql_fetch_array($res1)){
  $txt=$row1[txt];
