...
if(sqlzhuru($_POST[jvs])=="qxtk" && $row[ddzt]=="back"){
 ...
 if(panduan("uid,zfmm","epzhu_user where zfmm='".$zfmm."' and uid='".$_SESSION[SHOPUSER]."'")==0){Audit_alert("支付密码有误！","orderqxtkym.php?orderbh=".$orderbh);}
 if($row[ddzt]!="back"){Audit_alert("未知错误！","orderviewym.php?orderbh=".$orderbh);}
...
<div class="right">
 ...
 f1.action="orderqxtkym.php?orderbh=<?=$orderbh?>";
 }
 </script>
