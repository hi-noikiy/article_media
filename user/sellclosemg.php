...
if(sqlzhuru($_POST[jvs])=="close"){
 ...
 if(panduan("uid,zfmm","epzhu_user where zfmm='".$zfmm."' and uid='".$_SESSION[SHOPUSER]."'")==0){Audit_alert("支付密码有误！","sellclosemg.php?orderbh=".$orderbh);}
 ...
 $sj=date("Y-m-d H:i:s");
 updatetable("epzhu_ordermg","ddzt='close',closesj='".$sj."' where selluserid=".$userid." and id=".$row[id]);
...
<div class="right">
 ...
 <li class="l1"><a href="sellordermg.php">所有订单</a></li>
 </ul>
 ...
 tjwait();
 f1.action="sellclosemg.php?orderbh=<?=$orderbh?>";
 }
 </script>
