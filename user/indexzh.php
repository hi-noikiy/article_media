...
<div class="iright">
 ...
 <!--推广E-->
  ...
  <div class="sell">
   ...
   <a href="sellorderzh.php?ddzt=wpay">等待付款(<strong><?=returncount("epzhu_orderzh where selluserid=".$row[id]." and ddzt='wpay'")?></strong>)</a>
   <a href="sellorderzh.php?ddzt=wait">等待发货(<strong><?=returncount("epzhu_orderzh where selluserid=".$row[id]." and ddzt='wait'")?></strong>)</a>
   <a href="sellorderzh.php?ddzt=db">正在担保(<strong><?=returncount("epzhu_orderzh where selluserid=".$row[id]." and ddzt='db'")?></strong>)</a>
   <a href="sellorderzh.php?ddzt=back">退款申请(<strong><?=returncount("epzhu_orderzh where selluserid=".$row[id]." and ddzt='back'")?></strong>)</a>
   <a href="sellorderzh.php?ddzt=suc">交易成功(<strong><?=returncount("epzhu_orderzh where selluserid=".$row[id]." and ddzt='suc'")?></strong>)</a>
   </div>
   ...
   <li class="l2">好评<br><?=returncount("epzhu_propjzh where selluserid=".$row[id]." and pjlx=1")?></li>
   <li class="l3">中评<br><?=returncount("epzhu_propjzh where selluserid=".$row[id]." and pjlx=2")?></li>
   <li class="l4">差评<br><?=returncount("epzhu_propjzh where selluserid=".$row[id]." and pjlx=3")?></li>
   </ul>
  ...
  <div class="buy">
   ...
   <div class="d1 dv"><span class="s1">等待付款</span><a class="s2" href="orderzh.php?ddzt=wpay"><?=returncount("epzhu_orderzh where ddzt='wpay' and userid=".$row[id])?></a></div>
   <div class="d2 dv"><span class="s1">正在交易</span><a class="s2" href="orderzh.php?ddzt=db"><?=returncount("epzhu_orderzh where ddzt='db' and userid=".$row[id])?></a></div>
   <div class="d3 dv"><span class="s1">正在退款</span><a class="s2" href="orderzh.php?ddzb=back"><?=returncount("epzhu_orderzh where ddzt='back' and userid=".$row[id])?></a></div>
  </div>
  <!--买家E-->
