...
layer.open({
  ...
  title:["商品分组","text-align:left"],
  skin: 'layui-layer-rim', //加上边框
  content:['protype2lxym.php?ty1id='+x, 'no'] 
});
}
function updty1(x){
layer.open({
  ...
  title:["商品分组","text-align:left"],
  skin: 'layui-layer-rim', //加上边框
  content:['protype1ym.php?bh='+x, 'no'] 
});
}
function updty2(x){
layer.open({
  ...
  title:["商品分组","text-align:left"],
  skin: 'layui-layer-rim', //加上边框
  content:['protype2ym.php?bh='+x, 'no'] 
});
}
function glover(x){
...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:;" onclick="NcheckDEL(15,'epzhu_protypeym')" class="a1">删除</a>
 ...
 <? while1("*","epzhu_protypeym where userid=".$luserid." and admin=1 and zt=0 order by xh asc");while($row1=mysql_fetch_array($res1)){?>
 ...
 <? while2("*","epzhu_protypeym where userid=".$luserid." and admin=2 and zt=0 and name1='".$row1[name1]."' order by xh asc");while($row2=mysql_fetch_array($res2)){?>
