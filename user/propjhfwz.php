...
while0("*","epzhu_propjwz where selluserid=".$userid." and id=".$id);if(!$row=mysql_fetch_array($res)){Audit_alert("来源错误","propjlistwz.php","parent.");}

if($_GET[control]=="update"){
 zwzr();
 updatetable("epzhu_propjwz","hf='".sqlzhuru($_POST[s1])."',hfsj='".$sj."' where selluserid=".$userid." and id=".$id);
