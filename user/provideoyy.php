...
while0("*","epzhu_provideo where bh='".$mybh."' and probh='".$bh."' and userid=".$userid);if(!$row=mysql_fetch_array($res)){php_toheader("provideolistyy.php?bh=".$bh);}
...
if($_GET[control]=="update"){
 ...
 php_toheader("provideoyy.php?t=suc&mybh=".$mybh."&bh=".$bh);
...
tjwait();
f1.action="provideoyy.php?bh=<?=$bh?>&control=update&mybh=<?=$row[bh]?>";
}
function infcha(){
...
<div class="right">
 ...
 <? systs("恭喜您，操作成功!","provideoyy.php?bh=".$bh."&mybh=".$_GET[mybh])?>
 ...
 <ul class="uk">
 <li class="l3"></li>
 <li class="l4"><? tjbtnr("下一步","provideolistyy.php?bh=".$bh)?></li>
 </ul>
