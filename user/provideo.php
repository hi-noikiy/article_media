...
while0("*","epzhu_provideo where bh='".$mybh."' and probh='".$bh."' and userid=".$userid);if(!$row=mysql_fetch_array($res)){php_toheader("provideolist.php?bh=".$bh);}
...
<div class="right">
 ...
 <ul class="uk">
 <li class="l3"></li>
 <li class="l4"><? tjbtnr("下一步","provideolist.php?bh=".$bh)?></li>
 </ul>
