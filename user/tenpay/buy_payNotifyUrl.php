...
while1("*","epzhu_dingdang where ddbh='".$out_trade_no."' and ddzt='等待买家付款'");if($row1=mysql_fetch_array($res1)){
 updatetable("epzhu_dingdang","sj='".$sj."',uip='".$uip."',ifok=1,alipayzt='TRADE_SUCCESS',ddzt='交易成功' where id=".$row1[id]);
 $money1=$row1["money1"];
