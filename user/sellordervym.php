 ...
 <div class="orderv2">
  ...
  <div class="ztcontrol">
   ...
   <div class="d2">
    ...
    <div class="ds3">
    <a href="fahuoym.php?orderbh=<?=$orderbh?>" class="a1">发货</a>
    <a href="sellcloseym.php?orderbh=<?=$orderbh?>" class="a0">取消订单</a>
    </div>
    <? }?>
    ...
    <div class="ds3">
    <a href="selltkym.php?orderbh=<?=$orderbh?>" class="a1">处理退款</a>
    </div>
    <? }?>
    ...
    <div class="ds3"><a href="orderjf2ym.php?orderbh=<?=$orderbh?>" class="a1">查看记录</a></div>
    <? }?>

    <? if($row[ddzt]=="jfbuy"){?>
    <div class="ds1">平台已经判定本次交易纠纷为买家胜诉，款项已经退回到买家的账户。</div>
    <div class="ds3"><a href="orderjf2ym.php?orderbh=<?=$orderbh?>" class="a0">查看沟通记录</a></div>
    <? }?>
