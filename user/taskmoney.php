...
$userid=$rowuser[id];
$sqltask="select * from epzhu_task where bh='".$bh."' and taskty=1 and userid=".$userid." and zt=100";mysql_query("SET NAMES 'GBK'");$restask=mysql_query($sqltask);
...
if($_GET[control]=="jn"){
 ...
 updatetable("epzhu_task","zt=101,money2=".$rowtask[money1].",money3=".$money3." where id=".$rowtask[id]);
