...
function psel(){
 ...
 location.href="productlistkf.php?"+str;
}
</script>
</head>
<body>
...
<div class="right rightn">
 ...
 <li class="ltj"><input type="button" onclick="psel()" class="bt1" value="搜索" /> <input type="button" onclick="gourl('productlistkf.php')" class="bt2" value="重置" /></li>
 </ul>
 </div>
 <!--搜索E-->
 ...
 <div class="prolist">
  ...
  <li class="l2">
  <a href="javascript:void(0);" onclick="NcheckDEL(1,'epzhu_prokf')" class="a1">批量上/下架</a>
  <a href="javascript:void(0);" onclick="NcheckDEL(2,'epzhu_prokf')" class="a1">删除选中</a>
  <a href="javascript:void(0);" onclick="NcheckDEL(7,'epzhu_prokf')" class="a1">更新商品</a>
  ...
  <li class="l3"><a href="productlxkf.php">+添加新商品</a></li>
  </ul>
  <ul class="u1">
  <li class="l1">商品信息(共找到<?=returncount("epzhu_prokf".$ses)?>个)</li>
  <li class="l2">售价(元)</li>
  <li class="l3">库存</li>
  <li class="l4">销量</li>
  <li class="l5">最近更新</li>
  ...
  <?
  pagef($ses,10,"epzhu_prokf","order by lastsj desc");while($row=mysql_fetch_array($res)){
  $au1="productkf.php?bh=".$row[bh];
  $au2="../productkf/view".$row[id].".html";
  ?>
  <ul class="u2">
