...
if(sqlzhuru($_POST[jvs])=="pay"){
 ...
 if(panduan("*","epzhu_payreng where ddbh='".$t2."'")){Audit_alert("该支付宝订单号已经录入，无法重复提交","alipay_ewm.php");}
 $userid=returnuserid($_SESSION[SHOPUSER]);
 intotable("epzhu_payreng","money1,type1,userid,ddbh,sj,ifok","".$t1.",1,".$userid.",'".$t2."','".$sj."',1");
