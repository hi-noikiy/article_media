...
<div class="treebox">
 ...
 <li class="level1<? if($leftid==1){?> level11<? }?>">
  ...
  <? }else{?>
    <li><a href="<?=weburl?>user/sellorderwz.php">开发订单(<strong><?=returncount("epzhu_orderwz where selluserid=".$rowuser[id]." and ddzt='wait'")?></strong>)</a></li>

  <li><a href="<?=weburl?>user/shop.php">店铺设置</a></li>
  <li><a href="<?=returnmyweb($rowuser[id],$rowuser[myweb])?>" target="_blank">预览店铺</a></li>
  <li><a href="<?=weburl?>user/productlistwz.php">商品列表</a></li>
  <li><a href="javascript:void(0)" class="share">发布出售</a></li>
  <li><a href="<?=weburl?>user/productlistwz.php?ifxj=1">仓库中的宝贝</a></li>
  <li><a href="<?=weburl?>user/propjlistwz.php">评价管理</a></li>
  <li><a href="<?=weburl?>user/sellorderwz.php">订单管理</a></li>
 ...
 <li class="level1<? if($leftid==1){?> level11<? }?>">
  ...
  <ul class="level2">
  <li><a href="<?=weburl?>user/orderwz.php">我的订单</a></li>
  <li><a href="<?=weburl?>user/carwz.php">购物车</a></li>
  <li><a href="<?=weburl?>user/favprowz.php">我的收藏</a></li>
  </ul>
 </li>
