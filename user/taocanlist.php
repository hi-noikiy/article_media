...
<div class="right">
 ...
 <a href="javascript:NcheckDEL(9,'epzhu_taocan')" class="a2">删除</a>
 </li>
 <li class="l3"></li>
 </ul>

 <?
 while1("*","epzhu_taocan where probh='".$bh."' and userid=".$luserid." and zt=0 and admin is null order by xh asc");while($row1=mysql_fetch_array($res1)){
 ...
 <?
 while2("*","epzhu_taocan where admin=2 and tit='".$row1[tit]."' and zt=0 and userid=".$luserid." and probh='".$bh."' order by xh asc");while($row2=mysql_fetch_array($res2)){
