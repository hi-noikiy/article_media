...
<div class="right">
 ...
 while2("*","epzhu_user where id=".$row[useridhf]);$row2=mysql_fetch_array($res2);
 ?>
 <ul class="taskbj">
 <li class="l1"><?=$row2[nc]?></li>
 <li class="l2"><strong><?=$row[money1]?></strong>元</li>
 <li class="l3"><strong><?=returncount("epzhu_task where zt=5 and useridhf=".$row[useridhf]."")?></strong>次</li>
 <li class="l4"><strong><?=returncount("epzhu_task where zt=9 and useridhf=".$row[useridhf]."")?></strong>次</li>
