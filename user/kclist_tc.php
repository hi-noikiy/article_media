...
<div class="right">
 <ul class="wz">
 <li class="l0">请选择：</li>
 <li class="g_ac0_h g_bc0_h" id="rcap1"><a href="kclist_tc.php?bh=<?=$bh?>&tcid=<?=$tcid?>">库存管理</a></li>
 </ul>
 ...
 <li class="l1">库存统计：</li>
 <li class="l21">
 已使用（<strong class="red"><?=returncount("epzhu_taocan_kc where userid=".$luserid." and probh='".$bh."' and ifok=1 and tcid=".$tcid)?></strong>）&nbsp;&nbsp;&nbsp;&nbsp;
 未使用（<strong class="blue"><?=returncount("epzhu_taocan_kc where userid=".$luserid." and probh='".$bh."' and ifok=0 and tcid=".$tcid)?></strong>）
 </li>
 </ul> 
 </div>
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:NcheckDEL('5t','epzhu_kc')" class="a1">删除</a>
