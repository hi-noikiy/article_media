...
$sqltaskhf="select * from epzhu_taskhf where bh='".$bh."' and useridhf=".$useridhf." and taskty=1 and zt=0 and id=".$hfid."";mysql_query("SET NAMES 'GBK'");$restaskhf=mysql_query($sqltaskhf);
...
if($_GET[control]=="ys"){
 ...
 updatetable("epzhu_taskhf","ystxt='".sqlzhuru($_POST[content])."',oksj='".$oksj."',zt=1 where id=".$hfid);
 $sj=date("Y-m-d H:i:s");
