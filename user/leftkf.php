...
<div class="treebox">
 ...
 <li class="level1<? if($leftid==1){?> level11<? }?>">
  ...
  <? }else{?>
    <li><a href="<?=weburl?>user/sellorderkf.php">开发订单(<strong><?=returncount("epzhu_orderkf where selluserid=".$rowuser[id]." and ddzt='wait'")?></strong>)</a></li>

  <li><a href="<?=weburl?>user/shop.php">店铺设置</a></li>
  <li><a href="<?=returnmyweb($rowuser[id],$rowuser[myweb])?>" target="_blank">预览店铺</a></li>
  <li><a href="<?=weburl?>user/productlistkf.php">商品列表</a></li>
  <li><a href="javascript:void(0)" class="share">发布出售</a></li>
  <li><a href="<?=weburl?>user/productlistkf.php?ifxj=1">仓库中的宝贝</a></li>
  <li><a href="<?=weburl?>user/propjlistkf.php">评价管理</a></li>
  <li><a href="<?=weburl?>user/sellorderkf.php">订单管理</a></li>
 ...
 <li class="level1<? if($leftid==1){?> level11<? }?>">
  ...
  <ul class="level2">
  <li><a href="<?=weburl?>user/orderkf.php">我的订单</a></li>
  <li><a href="<?=weburl?>user/carkf.php">购物车</a></li>
  <li><a href="<?=weburl?>user/favprokf.php">我的收藏</a></li>
  </ul>
 </li>
