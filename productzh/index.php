...
$ty1id=returnsx("j");if($ty1id!=-1){
 $sqlty1="select * from epzhu_typezh where admin=1 and id=".$ty1id;mysql_query("SET NAMES 'GBK'");$resty1=mysql_query($sqlty1);$rowty1=mysql_fetch_array($resty1);
...
<div class="yjcode">
 ...
 <? if($ty1id!=-1){if(panduan("*","epzhu_typezh where admin=2 and type1='".$ty1name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while1("*","epzhu_typezh where admin=2 and type1='".$ty1name."' order by xh asc");while($row1=mysql_fetch_array($res1)){?>
 ...
 <? if($ty2id!=-1){if(panduan("*","epzhu_typezh where admin=3 and type1='".$ty1name."' and type2='".$ty2name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typezh where admin=3 and type1='".$ty1name."' and type2='".$ty2name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <? if($ty3id!=-1){if(panduan("*","epzhu_typezh where admin=4 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typezh where admin=4 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <? if($ty4id!=-1){if(panduan("*","epzhu_typezh where admin=5 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typezh where admin=5 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 $si=0;
 $sbarr=array();
 while1("*","epzhu_typesxzh where admin=1 and typeid=".$ty1id." and ifsel=1 order by xh asc");while($row1=mysql_fetch_array($res1)){
 $ev="e".$row1[id]."_";
 $sbarr[$si]=$ev;
 ?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while2("*","epzhu_typesxzh where admin=2 and name1='".$row1[name1]."' and typeid=".$row1[typeid]." order by xh asc");while($row2=mysql_fetch_array($res2)){?>
 ...
 for($si=0;$si<count($sbarr);$si++){
  ...
  if($tsx!=-1){
   while1("*","epzhu_typesxzh where id=".$tsx);if($row1=mysql_fetch_array($res1)){
   if($row1[admin]==2){
 ?>
 ...
 <? }?>
  ...
  <p class="info2"><a href="<?=$au?>" class="xq" target="_blank"><i></i>查看详情</a><? if(!empty($row[ysweb])){?><a href="<?=$row[ysweb]?>" target="_blank" class="ys"><i></i>查看演示</a><? }else{?><a  target="_blank" class="ys"><i></i>无演示站<? }?></a></p>
   ...
   for($i=0;$i<=count($a);$i++){
    ...
    while1("*","epzhu_typesxzh where id=".$ai);if($row1=mysql_fetch_array($res1)){
...
-->
  ...
  $a2="none";
  if(!empty($myuserid)){
   if(panduan("*","epzhu_carzh where userid=".$myuserid." and probh='".$row[bh]."'")==1){$a1="none";$a2="";}
  }
  ?>
