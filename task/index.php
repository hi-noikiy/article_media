...
<div class="yjcode">
 ...
 <div class="hy">
  ...
  <li class="l1"><strong class="s1">发起任务</strong><strong class="s2 green"><?=returncount("epzhu_task where userid=".$rowuser[id]."")?></strong></li>
  <li class="l1"><strong class="s1">接手任务</strong><strong class="s2 blue"><?=returncount("epzhu_task where useridhf=".$rowuser[id]." and taskty=0")+returncount("epzhu_taskhf where useridhf=".$rowuser[id]." and taskty=1")?></strong></li>
  <li class="l1 l0"><strong class="s1">交易成功</strong><strong class="s2"><?=returncount("epzhu_task where userid=".$rowuser[id]." and (zt=5 or zt=102)")+returncount("epzhu_task where useridhf=".$rowuser[id]." and taskty=0 and zt=5")+returncount("epzhu_taskhf where useridhf=".$rowuser[id]." and taskty=1 and zt=2")?></strong></li>
  </ul>
  </div>
  <? }else{?>
  <div class="d0">
