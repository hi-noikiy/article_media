...
re = /^[0-9a-z_]+$/gi;
if(t1v.length<4 || t1v.length>20 || !re.test(t1v)){document.getElementById("ts1").innerHTML="<span class='red'>帐号 字母、数字、组合</span>";document.getElementById("imgts1").innerHTML="<img src='img/err.gif' />";return false;}	
...
document.getElementById("ts2").innerHTML="<span class='red'>密码 6-20个字母、组合</span>";document.getElementById("imgts2").innerHTML="<img src='img/err.gif' />";return false;
}else{
document.getElementById("ts2").innerHTML="密码 6-20个字母、数字、组合";document.getElementById("imgts2").innerHTML="<img src='img/suc.gif' />";ifpwd1ok=1;return false;
}
}
function pwd2chk(){
ifpwd2ok=0;
