...
if(panduan("uid,mot","epzhu_user where mot='".$mob."' and uid='".$_GET[uid]."'")==0){echo "True";exit;}
if(strtolower($_SESSION["authnum_session"])!=strtolower($_GET[tyzm])){echo "err1";exit;}

while1("*","epzhu_smsmb where mybh='001'");
...
updatetable("epzhu_user","getpwd='".$yz."' where uid='".$_GET[uid]."'");echo "ok";exit;
