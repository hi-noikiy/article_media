...
var timer;
$(".index_tab div:not([class='no_ck'])").on({
"mouseenter":function(){
  $this=$(this);
    clearTimeout(timer);
    timer=setTimeout(function(){
     $this.attr("id",'cur').siblings('div').removeAttr("id");
		$('.i_c_div').hide();
		...
		$(".w_d_list .l2").hover(
			function(){
				...
				item1Timer=setTimeout(function(){
					$(that).children("span").show().animate({"top":0,height:145},300);
				},100);
			},
			function(){
			var that=$(this);
						clearTimeout(item1Timer);
		$(that).children("span").animate({"top":75,height:0},300,function(){
