...
var jscolor = {
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			p.padM.style.backgroundImage = "url('http://static.928vip.cn/js/color/cross.gif')";
			p.padM.style.backgroundRepeat = "no-repeat";
			p.sldM.style.backgroundImage = "url('http://static.928vip.cn/js/color/arrow.gif')";
			p.sldM.style.backgroundRepeat = "no-repeat";
			p.pad.style.backgroundImage = "url('http://static.928vip.cn/js/color/"+padImg+"')";
