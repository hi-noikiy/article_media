...
<div class="yjcode">
 ...
 <!--头条B-->
 <? 
 while1("*","epzhu_news where indextop=1 and zt=0 order by lastsj desc limit 1");if($row1=mysql_fetch_array($res1)){
 ...
 <div class="d1">
 <? 
 while0("*","epzhu_news where type1id=".$row1[id]." and zt=0 order by lastsj desc limit 9");while($row=mysql_fetch_array($res)){
 ...
 <div class="d2">
 <? 
 while2("*","epzhu_news where type1id=".$row1[id]." and zt=0 and iftp=1 order by lastsj desc limit 1");while($row2=mysql_fetch_array($res2)){
...
<div class="qh">
 <div class="container" id="idTransformView">
  ...
  $i=1;
  autoAD("ADN00");
  while1("*","epzhu_ad where zt=0 and adbh='ADN00' order by xh asc");while($row1=mysql_fetch_array($res1)){
  ?>
