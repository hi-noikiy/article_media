...
$ty1id=returnsx("j");if($ty1id!=-1){
 $sqlty1="select * from epzhu_typemg where admin=1 and id=".$ty1id;mysql_query("SET NAMES 'GBK'");$resty1=mysql_query($sqlty1);$rowty1=mysql_fetch_array($resty1);
...
<div class="yjcode">
 ...
 <? if($ty1id!=-1){if(panduan("*","epzhu_typemg where admin=2 and type1='".$ty1name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while1("*","epzhu_typemg where admin=2 and type1='".$ty1name."' order by xh asc");while($row1=mysql_fetch_array($res1)){?>
 ...
 <? if($ty2id!=-1){if(panduan("*","epzhu_typemg where admin=3 and type1='".$ty1name."' and type2='".$ty2name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typemg where admin=3 and type1='".$ty1name."' and type2='".$ty2name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <? if($ty3id!=-1){if(panduan("*","epzhu_typemg where admin=4 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typemg where admin=4 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <? if($ty4id!=-1){if(panduan("*","epzhu_typemg where admin=5 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typemg where admin=5 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <div class="list_nav">
 <li class="type"><a href="/user/productlxmg.php" class="cur">产品展示</a></li>
<!-- <li class="ipost"><a href="/user/productlxkf.php" class="ipost">我也要发布开发</a></li>-->
 ...
 <? }?>
  ...
  <span>付款人数 <?=$row[xsnum]?> 人</span></li>
  <li class="l2"><a href="<?=$au?>" title="<?=$row[tit]?>" target="_blank"><?=$tit?></a></li> 
  <?
  $a1="";
  $a2="none";
  if(!empty($myuserid)){
   if(panduan("*","epzhu_carmg where userid=".$myuserid." and probh='".$row[bh]."'")==1){$a1="none";$a2="";}
  }
  ?>
