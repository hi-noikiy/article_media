...
deletetable("epzhu_promg where zt=99 and sj<='".$nsj."'");
deletetable("epzhu_protypemg where zt=99 and sj<='".$nsj."'");
...
function delproduct($b,$u){
 ...
 deletetable("epzhu_propjmg where probh='".$b."'");
 ...
 deletetable("epzhu_prouserdjmg where probh='".$b."'");
 deletetable("epzhu_provideo where probh='".$b."'");
 delDirAndFile("../upload/".$u."/".$b."/");
 deletetable("epzhu_promg where bh='".$b."'");
}
...
if(is_numeric($userid)){
 ...
 while3("bh,userid","epzhu_promg where userid=".$userid);while($row3=mysql_fetch_array($res3)){delproduct($row3[bh],$row3[userid]);}
 deletetable("epzhu_protype where userid=".$userid);
 deletetable("epzhu_shopmenu where userid=".$userid);
 deletetable("epzhu_propjmg where userid=".$userid);
 ...
 deletetable("epzhu_prouserdjmg where userid=".$userid);
...
function kamikc($b){
 if(!empty($b)){
  if(panduan("bh,fhxs","epzhu_promg where bh='".$b."' and fhxs=4")==1){
  $a=returncount("epzhu_kc where ifok=0 and probh='".$b."'");
  updatetable("epzhu_promg","kcnum=".$a." where bh='".$b."'");
  }
 }
}
