...
function ser(){
location.href="productlist.php?st1="+document.getElementById("st1").value+"&st3="+document.getElementById("st3").value+"&sd1="+document.getElementById("sd1").value;	
}
</script>
</head>
<body>
...
<div class="yjcode">
 <? $leftid=1;include("menu_productfenleiquan.php");?>
...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(12,'epzhu_pro')" class="a2">变更审核</a>
 <a href="javascript:checkDEL(13,'epzhu_pro')" class="a2">上/下架</a>
 <a href="javascript:checkDEL(14,'epzhu_pro')" class="a1">删除</a>
 </li>
 </ul>
 <ul class="productcap">
