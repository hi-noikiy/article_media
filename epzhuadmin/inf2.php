...
<div class="right">
 ...
 <li class="l2"><input name="m1" value="<?=$row[mailname];?>" size="20" type="text" class="inp" /><span class="fd"><a href="http://www.epzhu.com/thread-2-1-1.html" target="_blank">如何设置？</a></span></li>
 <li class="l1">邮箱密码：</li>
 <li class="l2">
 ...
 <span class="fd"><a href="http://www.epzhu.com/thread-3-1-1.html" target="_blank">如何设置？</a></span>
 </li>
 ...
 <span class="fd"><a href="http://www.epzhu.com/thread-4-1-1.html" target="_blank">[查看教程]</a></span>
 </li>
 ...
 <label><input name="Rsmsmode" onclick="smsmdcha(1)" type="radio" value="1" <? if($row[smsmode]==1){?> checked="checked"<? }?> /> 模板发送形式（阿里大于）<a href="http://www.epzhu.com/thread-4-1-1.html" target="_blank" class="red">配置说明</a></label>&nbsp;&nbsp;
 <label><input name="Rsmsmode" onclick="smsmdcha(2)" type="radio" value="2" <? if($row[smsmode]==2){?> checked="checked"<? }?> /> 模板发送形式（阿里通信）<a href="http://www.epzhu.com/thread-5-1-1.html" target="_blank" class="red">配置说明</a></label>
 </li>
 </ul>
