...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(26,'epzhu_moneyrecord')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="mlistcap">
 ...
 <? pagef($ses,20,"epzhu_moneyrecord","order by sj desc");while($row=mysql_fetch_array($res)){?>
 <ul class="mlist">
 <li class="l1"><input name="C1" type="checkbox" value="<?=$row[id]?>" /></li>
 <li class="l2"><font title="<?=$row[tit]?>"><?=returntitdian($row[tit],60)?></font></li>
