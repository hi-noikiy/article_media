...
function ser(){
location.href="propjlist.php?st1="+document.getElementById("st1").value;	
}
</script>
</head>
<body>
...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(27,'epzhu_propj')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="propj">
 ...
 <?
 pagef($ses,20,"epzhu_propj","order by sj desc");while($row=mysql_fetch_array($res)){
