...
if($_GET[control]=="add"){
 ...
 zwzr();
 if(panduan("*","epzhu_tasktype where admin=1 and name1='".sqlzhuru($_POST[t1])."'")==1){Audit_alert("该分组已存在！","tasktype.php");}
...
<div class="right">
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" value="<?=returnxh("epzhu_tasktype","")?>" /> <span class="fd">序号越小，越靠前</span></li>
