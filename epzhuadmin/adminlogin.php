...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(37,'epzhu_loginlog')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <?
 pagef(" where admin=2",20,"epzhu_loginlog","order by sj desc");while($row=mysql_fetch_array($res)){
 ?>
 <ul class="qjlist2">
 <li class="l1"><input name="C1" type="checkbox" value="<?=$row[id]?>" /></li>
 <li class="l2"><?=returnadmin($row[userid])?></li>
 <li class="l3">登录</li>
