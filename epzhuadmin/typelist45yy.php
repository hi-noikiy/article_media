...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="type4yy.php?ty1id=<?=$ty1id?>&ty2id=<?=$ty2id?>&ty3id=<?=$ty3id?>" class="a1">新增分类</a>
 <a href="javascript:checkDEL('3a','epzhu_typeyy')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <li class="l5"><a href="type5yy.php?ty1id=<?=$ty1id?>&ty2id=<?=$ty2id?>&ty3id=<?=$ty3id?>&ty4id=<?=$row1[id]?>">添加五级分类</a><span></span><a href="<?=$nu?>">编辑</a></li>
 </ul>
 <?
