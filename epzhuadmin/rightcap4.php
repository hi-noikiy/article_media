<?
$sqlpro="select * from epzhu_pro where bh='".$bh."'";mysql_query("SET NAMES 'GBK'");$respro=mysql_query($sqlpro);
...
?>
 <div class="rproglo">
 <ul class="u1">
 <li class="l1"><a href="../product/view<?=$rowpro[id]?>.html" target="_blank"><img border="0" class="tp" src="<?=$protp?>" width="80" height="80" /></a></li>
 ...
 <a href="provideolist.php?bh=<?=$bh?>" id="rtit2">商品视频</a>
 </div> 
