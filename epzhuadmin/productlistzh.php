...
function ser(){
location.href="productlistzh.php?st1="+document.getElementById("st1").value+"&st3="+document.getElementById("st3").value+"&sd1="+document.getElementById("sd1").value;	
}
</script>
</head>
<body>
...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="productlistzh.php">商品列表</a>
 </div>
 <!--B-->
 <ul class="psel">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(12,'epzhu_prozh')" class="a2">变更审核</a>
 <a href="javascript:checkDEL(13,'epzhu_prozh')" class="a2">上/下架</a>
 <a href="javascript:checkDEL(14,'epzhu_prozh')" class="a1">删除</a>
 </li>
 </ul>
 <ul class="productcap">
 ...
 <a href="../productzh/view<?=$row[id]?>.html" target="_blank">预览</a>
 </li>
 </ul>
 <? }?>
 <?
