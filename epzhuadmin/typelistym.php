...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="typelistym.php">商品分组</a>
 </div>
 <div class="rights">
 <strong>提示：</strong><br>
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="type1ym.php" class="a1">新增分类</a>
 <a href="javascript:checkDEL(4,'epzhu_typeym')" class="a2">删除</a>
 </li>
 </ul>
 ...
 <li class="l2">
 <a href="typelistsym.php?ty1id=<?=$row1[id]?>"><strong><?=$row1[type1]?></strong></a><? if(empty($row1[iftj])){?> <span class="red">(推荐)</span><? }?>
 </li>
 ...
 <li class="l8">
 <a href="type2ym.php?ty1id=<?=$row1[id]?>">子类</a><span></span>
 <a href="<?=$nu?>">编辑</a><span></span><a href="typesxlistym.php?typeid=<?=$row1[id]?>">附加选项</a>
 </li>
 </ul>
 <? }?>
 <!--end-->
