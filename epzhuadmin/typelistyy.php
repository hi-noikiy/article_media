...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="typelistyy.php">商品分组</a>
 </div>
 <div class="rights">
 <strong>提示：</strong><br>
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="type1yy.php" class="a1">新增分类</a>
 <a href="javascript:checkDEL(4,'epzhu_typeyy')" class="a2">删除</a>
 </li>
 </ul>
 ...
 $nu="type1yy.php?action=update&id=".$row1[id];
 ?>
 <ul class="typelist">
 <li class="l1"><input name="C1" type="checkbox" value="<?=$row1[id]?>" /></li>
 <li class="l2">
 <a href="typelistsyy.php?ty1id=<?=$row1[id]?>"><strong><?=$row1[type1]?></strong></a><? if(empty($row1[iftj])){?> <span class="red">(推荐)</span><? }?>
 </li>
 ...
 <li class="l8">
 <a href="type2yy.php?ty1id=<?=$row1[id]?>">子类</a><span></span>
 <a href="<?=$nu?>">编辑</a><span></span><a href="typesxlistyy.php?typeid=<?=$row1[id]?>">附加选项</a>
 </li>
 </ul>
 <? }?>
 <!--end-->
