...
if($_GET[control]=="add"){
 ...
 {Audit_alert("该分组已存在！","type5ym.php?ty1id=".$ty1id."&ty2id=".$ty2id."&ty3id=".$ty3id."&ty4id=".$ty4id);}
 ...
 {Audit_alert("该分组已存在！","type5ym.php?action=update&id=".$_GET[id]."&ty1id=".$ty1id."&ty2id=".$ty2id."&ty3id=".$ty3id."&ty4id=".$ty4id);}
...
<div class="right">
 ...
 <? if($_GET[t]=="suc"){systs("恭喜您，操作成功！","type5ym.php?action=".$_GET[action]."&ty1id=".$ty1id."&ty2id=".$ty2id."&ty3id=".$ty3id."&ty4id=".$ty4id."&id=".$_GET[id]);}?>
 <div class="bqu1">
 ...
 <li class="l1">排序：</li>
 <li class="l2"><input type="text" class="inp" name="t2" value="<?=returnxh("epzhu_typeym"," and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."' and admin=5")?>" /> <span class="fd">序号越小，越靠前</span></li>
