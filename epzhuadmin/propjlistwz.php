...
function ser(){
location.href="propjlistwz.php?st1="+document.getElementById("st1").value;	
}
</script>
</head>
<body>
...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="propjlistwz.php">商品评价</a>
 </div>
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(27,'epzhu_propjwz')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="propj">
 ...
 <?
 pagef($ses,20,"epzhu_propjwz","order by sj desc");while($row=mysql_fetch_array($res)){
 $aurl="propjwz.php?id=".$row[id];
 ?>
 <ul class="propjlist">
