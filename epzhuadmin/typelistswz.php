...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="type2wz.php?ty1id=<?=$ty1id?>" class="a1">新增子类</a>
 <a href="javascript:checkDEL(3,'epzhu_typewz')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 $nu="type2wz.php?ty1id=".$ty1id."&action=update&id=".$row1[id];
 ?>
 <ul class="qjlist1">
 ...
 <li class="l5"><a href="type3wz.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>">添加三级类别</a><span></span><a href="<?=$nu?>">编辑</a></li>
 </ul>
 <?
 while2("*","epzhu_typewz where admin=3 and type1='".$row1[type1]."' and type2='".$row1[type2]."' order by xh asc");while($row2=mysql_fetch_array($res2)){
 ...
 <li class="l2">&nbsp;&nbsp;<a href="typelist45wz.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>&ty3id=<?=$row2[id]?>">- <?=$row2[type3]?></a></li>
 <li class="l3"><?=$row2[xh]?></li>
 <li class="l4"><?=$row2[sj]?></li>
 <li class="l5"><a href="type4wz.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>&ty3id=<?=$row2[id]?>">添加四级类别</a><span></span><a href="<?=$nu?>">编辑</a></li>
 </ul>
 <?
 }
 }
