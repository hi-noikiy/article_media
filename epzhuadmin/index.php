...
if($_GET[a]=="login"){
 ...
 zwzr();
 while0("*","epzhu_admin where adminuid='".sqlzhuru($_POST[t1])."' and adminpwd='".sha1(sqlzhuru($_POST[t2]))."'");if($row=mysql_fetch_array($res)){
 $sj=date("Y-m-d H:i:s");
 $uip=$_SERVER["REMOTE_ADDR"];
 intotable("epzhu_loginlog","admin,userid,sj,uip","2,".$row[id].",'".$sj."','".$uip."'");
