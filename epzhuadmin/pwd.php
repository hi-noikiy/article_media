...
if(sqlzhuru($_POST[xl])==sha1("pwd")){
 ...
 if(panduan("*","epzhu_admin where adminpwd='".sha1(sqlzhuru($_POST[t0]))."' and adminuid='".$_SESSION[SHOPADMIN]."'")==1){
 updatetable("epzhu_admin","adminpwd='".sha1(sqlzhuru($_POST[t1]))."' where adminuid='".$_SESSION[SHOPADMIN]."'");
