<?
$sqlpro="select * from epzhu_prozh where bh='".$bh."'";mysql_query("SET NAMES 'GBK'");$respro=mysql_query($sqlpro);
if(!$rowpro=mysql_fetch_array($respro)){php_toheader("productlistzh.php");}
...
?>
 ...
 <div class="bqu1">
 <a href="productzh.php?bh=<?=$bh?>" id="rtit1">基本资料</a>
 <a href="provideolistzh.php?bh=<?=$bh?>" id="rtit2">商品视频</a>
 </div> 
