...
<div class="right">
 ...
 <? 
 while0("*","epzhu_ad where bh='".$_GET[bh]."'");$row=mysql_fetch_array($res);
 ...
 <li class="l8"></li>
 <li class="l9"style="margin-bottom: 10px;"><img src="../gg/<?=$row[bh]?>.<?=$row[jpggif]?>?t=<?=rnd_num(100)?>" height="100%" /></li>
 </ul>
