...
function ser(){
location.href="propjlistmg.php?st1="+document.getElementById("st1").value;	
}
</script>
</head>
<body>
...
<div class="right">
 ...
 <div class="bqu1">
 <a class="a1" href="propjlistmg.php">商品评价</a>
 </div>
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(27,'epzhu_propjmg')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="propj">
 ...
 <?
 pagef($ses,20,"epzhu_propjmg","order by sj desc");while($row=mysql_fetch_array($res)){
 $aurl="propjmg.php?id=".$row[id];
 ?>
 <ul class="propjlist">
