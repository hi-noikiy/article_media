...
$ty1id=$_GET[ty1id];
while0("*","epzhu_taocan where id=".$ty1id);$row=mysql_fetch_array($res);
$ty1tit=$row[tit];
...
if($_GET[control]=="update"){
 ...
 zwzr();
 if(panduan("*","epzhu_taocan where admin=2 and tit='".sqlzhuru($_POST[t0])."' and tit2='".sqlzhuru($_POST[t1])."' and probh='".$bh."' and id<>".$id)==1){Audit_alert("该套餐说明已存在！","taocan1.php?action=update&id=".$id."&ty1id=".$ty1id."&bh=".$bh);}
