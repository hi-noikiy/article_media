...
<div class="right" id="right">
 ...
 <ul class="typecon">
 <li class="l1">
 <a href="javascript:checkDEL(30,'epzhu_tp')" class="a2">删除</a>
 </li>
 </ul>
 <? while1("*","epzhu_tp where bh='".$bh."' order by xh asc");while($row1=mysql_fetch_array($res1)){$tp="../".str_replace(".","-2.",$row1[tp]);?>
 <ul class="typelist3">
