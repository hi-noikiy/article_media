...
if($_GET[control]=="update"){
 ...
 zwzr();
 if(panduan("*","epzhu_taocan where admin is null and probh='".$bh."' and zt<>99 and tit='".sqlzhuru($_POST[t1])."' and id<>".$id)==1){Audit_alert("该套餐内容已存在！","taocan.php?action=update&id=".$id."&bh=".$bh);}
