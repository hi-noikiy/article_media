...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="javascript:checkDEL(39,'epzhu_baomoneyrecord')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="psel">
 ...
 <? pagef($ses,20,"epzhu_baomoneyrecord","order by sj desc");while($row=mysql_fetch_array($res)){$au="baomoney.php?id=".$row[id];?>
 <ul class="mlist">
