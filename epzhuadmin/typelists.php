...
<div class="right">
 ...
 <a href="javascript:checkDEL(3,'epzhu_type')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <?
 while2("*","epzhu_type where admin=3 and type1='".$row1[type1]."' and type2='".$row1[type2]."' order by xh asc");while($row2=mysql_fetch_array($res2)){
