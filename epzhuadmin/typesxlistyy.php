...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="typesxyy.php?typeid=<?=$typeid?>" class="a1">新增选项</a>
 <a href="javascript:checkDEL(18,'epzhu_typesxyy')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <li class="l5"><a href="typesx1yy.php?ty1id=<?=$row1[id]?>">添加二级选项</a><span></span><a href="<?=$nu?>">编辑</a></li>
 </ul>
 <?
