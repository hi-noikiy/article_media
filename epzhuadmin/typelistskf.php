...
<div class="right">
 ...
 <ul class="ksedi">
 <li class="l2">
 <a href="type2kf.php?ty1id=<?=$ty1id?>" class="a1">新增子类</a>
 <a href="javascript:checkDEL(3,'epzhu_typekf')" class="a2">删除</a>
 </li>
 </ul>
 <ul class="qjlistcap">
 ...
 <li class="l5"><a href="type3kf.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>">添加三级类别</a><span></span><a href="<?=$nu?>">编辑</a></li>
 </ul>
 <?
 ...
 <li class="l5"><a href="type4kf.php?ty1id=<?=$ty1id?>&ty2id=<?=$row1[id]?>&ty3id=<?=$row2[id]?>">添加四级类别</a><span></span><a href="<?=$nu?>">编辑</a></li>
 </ul>
 <?
 }
 }
