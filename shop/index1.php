...
<div class="yjcode">
 ...
 <li class="l3">宝贝数量：<?=returncount("epzhu_pro where zt=0 and ifxj=0 and userid=".$row1[id])?>件</li>
 <li class="l4">
 ...
 <span class="s1">商品数量<br><strong class="feng"><?=returncount("epzhu_pro where zt=0 and ifxj=0 and userid=".$row[id])?></strong></span>
