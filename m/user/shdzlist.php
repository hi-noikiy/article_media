...
$sj=date("Y-m-d H:i:s");
if($_GET[control]=="del"){
deletetable("epzhu_shdz where userid=".$userid." and id=".$_GET[id]);
...
<div class="boxcap box">
 ...
 pagef(" where zt=0 and userid=".$userid,10,"epzhu_shdz","order by sj desc");while($row=mysql_fetch_array($res)){
 ...
 <div class="fbbtn box">
 <div class="d1" onClick="gourl('shdzlx.php')"><input type="button" value="添加新地址" /></div>
 </div>
 <? include("bottom.php");?>
</body>
</html>