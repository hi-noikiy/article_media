 ...
 ?>
 <div class="orderm box"><div class="d1">商品信息</div><div class="d2"><a href="<?=$au?>"><?=$row[tit]?></a></div></div>
...
<div class="orderm box"><div class="d1">卖家信息<span class="s1"></span></div><div class="d2"><?=returnnc($row[selluserid])?></div></div>
<? $mqq=returnqq($row[selluserid]);if(!empty($mqq)){?>
<div class="orderm box"><div class="d1">卖家QQ<span class="s1"></span></div><div class="d2"><a href="http://wpa.qq.com/msgrd?v=3&uin=<?=$mqq?>&site=<?=weburl?>&menu=yes" target="_blank"><?=$mqq?> [点击联系]</a></div></div>
<? }?>