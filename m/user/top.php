...
<div class="buytop1 box">
 <div class="d1" onclick="gourl('favpro.php')"><?=returncount("epzhu_profav where userid=".$rowuser[id])?><br>商品收藏</div>
 <div class="d1" onclick="gourl('favshop.php')"><?=returncount("epzhu_shopfav where userid=".$rowuser[id])?><br>店铺收藏</div>
