...
<div class="uk box">
 ...
 <div class="d2"><iframe style="float:left;" src="tpupload.php?admin=4" width="100" scrolling="no" height="23" frameborder="0"></iframe></div>
</div>
<div class="xgtp box">
<div class="xgtpm">
...
<div class="fbbtn box" onClick="gourl('smrz4.php')">
...
function deltp(x){
 ...
 $.get("tpdel.php",{admin:4},function(result){
  xgtread(4,'');
