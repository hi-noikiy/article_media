		...
		//判断签名
			if ($data['result_code'] == 'SUCCESS') {
				 ...
				 // 获取log_id
					...
					$sql="select * from epzhu_dingdang where wxddbh='".$data['out_trade_no']."' and ifok=0";mysql_query("SET NAMES 'GBK'");$res=mysql_query($sql);
					if($row=mysql_fetch_array($res)){
						updatetable("epzhu_dingdang","sj='".$sj."',uip='".$uip."',alipayzt='TRADE_SUCCESS',ddzt='交易成功',ifok=1 where wxddbh='".$data['out_trade_no']."'");
						$money1=$row["money1"];
