...
<div class="bfbtop2 box">
 ...
 <div class="d2">我的商品(<?=returncount("epzhu_pro".$ses)?>个)</div>
 <div class="d4" onClick="gourl('productlx.php')">发布</div>
</div>

<div class="prots box"><div class="d1">刷新一个商品将消耗<strong class="feng"><?=$rowcontrol[sxjf]?></strong>分，您剩余<strong class="blue"><?=$rowuser[jf]?></strong>分</div></div>
