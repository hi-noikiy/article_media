...
<!--效果图B-->
<div class="uk box">
 <div class="d1">半身照片<span class="s1"></span></div>
 <div class="d2"><iframe style="float:left;" src="tpupload.php?admin=5" width="100" scrolling="no" height="23" frameborder="0"></iframe></div>
</div>
<div class="xgtp box">
<div class="xgtpm">
...
<div class="fbbtn box" onClick="gourl('smrz.php')">
 <div class="d1"><input type="button" class="tjinput" value="查看认证结果" /></div>
</div>
...
function deltp(x){
 ...
 $.get("tpdel.php",{admin:5},function(result){
  xgtread(5,'');
