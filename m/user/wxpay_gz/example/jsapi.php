...
zwzr();
updatetable("epzhu_user","uqq='".sqlzhuru($_POST[tuqq])."' where uid='".$_SESSION[SHOPUSER]."'");
$bh=time();
...
intotable("epzhu_dingdang","bh,ddbh,userid,sj,uip,money1,ddzt,alipayzt,bz,ifok,probh,pronum,tcid,wxddbh,buyform","'".$bh."','".$ddbh."',".$rowuser[id].",'".$sj."','".$uip."',".$money1.",'等待买家付款','','微信手机支付',0,'".$bharr."','".$numarr."','".$tcidarr."','".$_SESSION[wxddbh]."','".$buyformarr."'");
}
...
//②、统一下单
while1("*","epzhu_dingdang where wxddbh='".$_SESSION[wxddbh]."'");$row1=mysql_fetch_array($res1);$moneyv=$row1[money1]*100;
