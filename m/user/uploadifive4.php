...
while1("*","epzhu_user where id=".$userid." and pwd='".sqlzhuru($_POST[pwd])."' and (sfzrz=2 or sfzrz=3)");if(!$row1=mysql_fetch_array($res1)){echo "1";exit;}
...
updatetable("epzhu_user","sfzrz=0 where id=".$row1[id]);
?>