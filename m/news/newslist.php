...
<div class="search box">
 ...
 <? if($ty1id!=-1){if(panduan("*","epzhu_newstype where admin=2 and name1='".$ty1name."'")==1){?>
...
<div class="sertj box" id="sertj2" style="display:none;">
 ...
 <? while1("*","epzhu_newstype where admin=2 and name1='".$ty1name."' order by xh asc");while($row1=mysql_fetch_array($res1)){?>
...
<div class="yjcode">
<? 
$i=1;pagef($ses,10,"epzhu_news","order by lastsj desc");while($row=mysql_fetch_array($res)){
