...
<img src="/m/img/mkefu.png" title="555.png" style="
    width: 100%;
">
...
<div class="shezhi box"><div class="d1"><img src="/m/img/weixin.png" /></div><div class="d2">微信客服</div><div class="d3"><img src="../img/icon1.png" /></div></div>
<div class="txt box">
 <div class="d1"><?
 $a1=preg_split("/,/",$rowcontrol[webqqv]);
 for($i=0;$i<count($a1);$i++){
 ...
 <div class="shezhi box"><div class="d1"><img src="/tem/moban/huzhan/images/yizhanw.png" /></div><div class="d2">微信公主号</div><div class="d3"><img src="../img/icon1.png" /></div></div>
<div class="txt box">
 <div class="d1">qq28292383</div></div>
