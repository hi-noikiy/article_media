...
<div class="glotop1 box">
 <div class="d1" onClick="gourl('view<?=$id?>.html')"><img src="../img/leftjian.png" height="21" /></div>
 <div class="d2">评价信息</div>
 <div class="d4"></div>
</div>
<!--头部E-->
...
pagef(" where probh='".$row[bh]."'",20,"epzhu_propj","order by sj desc");while($row=mysql_fetch_array($res)){
