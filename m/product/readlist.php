...
pagef($ses,20,"epzhu_pro",$px);
echo "ok_epzhu_".$count;
...
echo "ok|".$row[id]."|".returntppd($tpv,"../../img/none180x180.gif")."|".returntitdian($row[tit],40)."|".returnjgdian(returnyhmoney($row[yhxs],$row[money2],$row[money3],$sj,$row[yhsj1],$row[yhsj2],$row[id]))."|".$ifauto."|".$row1[shopname]."|".returnxytp($xy)."|".$page_count."_epzhu_";
}
?>
