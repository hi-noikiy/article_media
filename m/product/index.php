...
<div class="indextop box">
 ...
 <div class="d2" onClick="gourl('../search/main.php')"><span class="s1"><img src="../img/ser.png" /></span><span class="s2">请输入搜索关键词！</span></div>
</div>
<!--头部E-->
...
<div class="psel box">
 <div class="search">
  ...
  <div class="d1" onClick="sertjonc(1,3)"><span class="s1"><? if($ty2id!=-1){echo $ty2name;}elseif($ty1id!=-1){echo $ty1name;}else{echo "全部分类";}?></span><span class="s2"><img src="../img/jiandown.png" /></span></div>
...
<div class="sertj box" id="sertj1" style="display:none;">
 <div class="d1">
 <a href="<?=rentser('j','','k','');?>" <? if(check_in("_jv",$getstr) || !check_in("_j",$getstr)){?> class="nx"<? }?>>不限</a>
 ...
 <? if(returnsx("j")!=-1){?>
 <div class="d1">
 <a href="<?=rentser('k','','','');?>" <? if(check_in("_kv",$getstr) || !check_in("_k",$getstr)){?> class="nx"<? }?>>不限</a>
