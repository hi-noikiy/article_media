...
.shdzok .d1{-webkit-box-flex:1;-moz-box-flex:1;box-flex:1;margin:0 1px 0 0;padding:10px 0 0 0;height:30px;background-color:#2d78d0;}
...
<div class="shdzt1 box">
 ...
 <div class="d2">
  ...
  <? while3("*","epzhu_city where level=1 order by xh asc");while($row3=mysql_fetch_array($res3)){?>
...
<div class="shdz box">
 ...
 <div class="d2">
  ...
  <? while1("*","epzhu_city where level=2".$ses1." order by xh asc");while($row1=mysql_fetch_array($res1)){?>
...
<div class="shdz box">
 ...
 <div class="d2">
  ...
  <? while2("*","epzhu_city where level=3".$ses2." order by xh asc");while($row2=mysql_fetch_array($res2)){?>
