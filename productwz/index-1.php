...
<div class="yjcode">
 ...
 <? if($ty2id!=-1){if(panduan("*","epzhu_typewz where admin=3 and type1='".$ty1name."' and type2='".$ty2name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typewz where admin=3 and type1='".$ty1name."' and type2='".$ty2name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <? if($ty3id!=-1){if(panduan("*","epzhu_typewz where admin=4 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typewz where admin=4 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <? if($ty4id!=-1){if(panduan("*","epzhu_typewz where admin=5 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."'")==1){?>
 <ul class="u2">
 ...
 <li class="l3">
 <? while3("*","epzhu_typewz where admin=5 and type1='".$ty1name."' and type2='".$ty2name."' and type3='".$ty3name."' and type4='".$ty4name."' order by xh asc");while($row3=mysql_fetch_array($res3)){?>
 ...
 <div class="list_nav">
 <li class="type"><a href="/user/productlxwz.php" class="cur">产品展示</a></li>
