...
function prosx2(b,c){
parent.ptype3.location="../tem/protype3ym.php?type1id=<?=$type1id?>&type2id="+b;
...
<body>
 ...
 <!--begin-->
  ...
  <a href="javascript:void(0);" class="a1"><?=$type1name?> <img border="0" src="../img/jiandown.gif" width="7" height="4" /></a>
   <? while2("*","epzhu_typeym where admin=2 and type1='".$type1name."' order by xh asc");while($row2=mysql_fetch_array($res2)){?>
