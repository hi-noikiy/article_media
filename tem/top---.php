...
?>
<div class="top_box">
	<div class="main">	<div class="top"> 		<div class="left">			<span id="notlogin">			<li class='not'>您好！欢迎来到<?=webname?></li>			<li class='not'>				<a href="<?=weburl?>reg/reg.php" class='T_a'><i class='iconfont va-2' style='font-size:18px;'>&#xe6aa;</i> 注册</a>			</li>			<li class='arrow'>				<a href="<?=weburl?>reg/" class='T_a'>登录<em class='arrow'></em></a>				<div class="change_div top_login"> 
					<a target="_blank" id='qq' href="<?=weburl?>config/qq/oauth/index.php" class='login_icon login_click'>QQ帐号登录</a>
