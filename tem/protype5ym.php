...
<body>
 ...
 <!--begin-->
  ...
  <a href="javascript:void(0);" class="a1"><?=$type4name?> <img border="0" src="../img/jiandown.gif" width="7" height="4" /></a>
   <?
   while0("*","epzhu_typeym where type1='".$type1name."' and type2='".$type2name."' and type3='".$type3name."' and type4='".$type4name."' and admin=5 order by xh asc");while($row=mysql_fetch_array($res)){
   ?>
