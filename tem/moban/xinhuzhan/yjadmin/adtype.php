...
<div class="right">
 ...
 <?
 $adbh=array("ADDL","ADLP","ADI00","ADI01","ADI02","ADI04","ADI05","ADI13","ADI14","ADTOP","ADI15");
 $adtit=array("对联广告","首页拉屏广告","首页顶部广告","底部广告","导航菜单","首页切换图片","顶部搜索框右方广告","首页底部合作伙伴","首页底部友情链接","全部顶部广告","首页直通车广告合作");
 $adsize=array("100*?","1150*?","1150*?","1150*?","","1960*396","250*75","100*35","","1150*?","100*35");
