...
$.get("/check/uqq.php?cim="+$this.html()+"&im="+$im,{cim:$this.html(),im:$im}, function(html){
	layer.ly(html,'<div class="layui-layer-title" style="cursor: move;"><img src="https://i.hmbwz.com/tx/snone.jpg" style="width:20px;height:20px;margin-left:-10px;float:left;margin-top:10px;padding:1px;border: 1px solid #ddd;"><strong style="float:left;max-width:130px;overflow:hidden;color:#ff6600;padding:0 5px;"">'+$arr[0]+'</strong> <span style="color:#666;float:left;">联系'+$tit+'</span></div>',true);
});
});
...
//QQ登陆
login_qq = function(){ 
		openwindow('https://www.hmbwz.com/api_login/qq/','QQ登陆',710,400)
}

//支付宝登陆
login_alipay = function(){ 
setCookie("apay_url",Durl,"5");
openwindow('https://www.hmbwz.com/api_login/alipay/','支付宝登陆',950,680);
}
