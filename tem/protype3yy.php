...
parent.ptype4.location="../tem/protype4yy.php?type1id=<?=$type1id?>&type2id=<?=$type2id?>&type3id="+a;
...
<body>
 ...
 <!--begin-->
  ...
  <a href="javascript:void(0);" class="a1"><?=$type2name?> <img border="0" src="../img/jiandown.gif" width="7" height="4" /></a>
   <?
   while0("*","epzhu_typeyy where type1='".$type1name."' and type2='".$type2name."' and admin=3 order by xh asc");while($row=mysql_fetch_array($res)){
   ?>
